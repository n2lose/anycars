                ...
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col">
                  ...
                  <div className="flex-1 flex-col gap-3">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                        <Image
                            src={generateCarImageUrl(carDetails, '39')}
                            alt="car model"
                            fill
                            priority
                            className="object-contain"
                        ...
                        <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                        <Image
                            src={generateCarImageUrl(carDetails, '01')}
                            alt="car model"
                            fill
                            priority
                            className="object-contain"
                  ...
                  <div className="flex flex-col flex-1 gap-2">
                    <h2 className="font-semibold text-xl capitalize">{carDetails.make} {carDetails.model}</h2>
